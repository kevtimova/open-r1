...
def get_dataset(args: ScriptArguments) -> DatasetDict:
    ...
    if args.dataset_name and not args.dataset_mixture:
        ...
        return load_from_disk('./data/mot_code_filtered_5k') if args.dataset_name == 'open-r1/Mixture-of-Thoughts' else datasets.load_dataset(args.dataset_name, args.dataset_config)
